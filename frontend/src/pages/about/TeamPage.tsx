      ...
      <div className="mx-auto w-full max-w-[1200px]">
        <header className="text-left">
          ...
          <p className="mt-4 w-full max-w-full text-base leading-[1.7] text-text/80">
            HDRWA brings together experts in information technology, data
            management, governance, partnerships and communications to support safe
            and effective data sharing.
          </p>
        </header>

        <section className="mt-14 w-full" aria-label="Team members">
